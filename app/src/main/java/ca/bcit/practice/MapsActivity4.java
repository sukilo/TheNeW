...
public class MapsActivity4 extends FragmentActivity
    ...
    private static final String TAG = MapsActivity3.class.getName();
    ...
    public void download() {
        Ion.with(this).
                load("http://opendata.newwestcity.ca/downloads/nonmarket-and-coop-housing/NONMARKET_AND_COOP_HOUSING.json").
                asJsonObject().
                setCallback(
    ...
    private void downloadSuccess(final JsonObject jsonObject) {
        ...
        for (final JsonElement element : features) {
            ...
            name = properties.get("Name").toString().replaceAll("\"","");
            desc = properties.get("Description").toString().replaceAll("\"","");
    ...
    private void displayPoints() {
        ...
        for (final String name : names) {
            ...
            desc = settings.getString(name + "-desc", "");
        ...
        googleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Intent i = new Intent(MapsActivity4.this, onMarkerClicked.class);
                markerTitle = marker.getTitle();
                markerDesc = marker.getSnippet();
