...
public class onMarkerClicked2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_marker_clicked2);
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.nav_home:
                                Intent home = new Intent(onMarkerClicked2.this, Home.class);
                                startActivity(home);
                                break;

                            case R.id.nav_about:
                                Intent about = new Intent(onMarkerClicked2.this, AboutUs.class);
                                startActivity(about);
                                break;

                            case R.id.nav_settings:
                                Intent settings = new Intent(onMarkerClicked2.this, Settings.class);
        ...
        description.setText("Address: " + getMDesc);
